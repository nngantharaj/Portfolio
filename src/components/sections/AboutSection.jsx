        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              >
                <button 
                  className="mt-6 bg-blue-300 dark:bg-blue-500 text-blue-900 dark:text-white px-8 py-3 rounded-full hover:bg-blue-400 dark:hover:bg-blue-600 transition-colors"
                >
                  View My Resume
                </button>
              </a>
